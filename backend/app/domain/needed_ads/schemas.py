...
class NeededAdCreate(NeededAdBase):
    extraction_confidence: Optional[float] = None
    extraction_warnings: Optional[Dict[str, Any]] = None
    status: AdStatus = AdStatus.PENDING

class NeededAdUpdate(NeededAdBase):
    raw_text: Optional[str] = None
    status: Optional[AdStatus] = None

class NeededAdInDBBase(NeededAdBase):
    id: int
    extraction_confidence: Optional[float] = None
    extraction_warnings: Optional[Dict[str, Any]] = None
    status: AdStatus
...
class NeededAd(NeededAdInDBBase):
    pass
